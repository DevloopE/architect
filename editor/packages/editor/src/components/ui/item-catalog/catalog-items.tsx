...
export const CATALOG_ITEMS: AssetInput[] = [
...

  {
    ...
    attachTo: 'ceiling',
    interactive: {
      controls: [{ kind: 'toggle' }, { kind: 'slider', label: 'Intensity', min: 0, max: 100, unit: '%', displayMode: 'dial', default: 100 }],
...

  {
    ...
    offset: [0, 0.9, 0],
    rotation: [0, 0, 0],
    dimensions: [0.8, 0.3, 0.8],
    attachTo: 'ceiling',
    interactive: {
      controls: [{ kind: 'toggle' }, { kind: 'slider', label: 'Intensity', min: 0, max: 100, unit: '%', displayMode: 'dial', default: 100 }],
      effects: [{ kind: 'light', intensityRange: [0, 2], color: '#ffffff', offset: [0, -0.2, 0] }],
    },
  },

  {
    ...
    offset: [0, 0.9, 0],
    rotation: [0, 0, 0],
    dimensions: [1.2, 0.2, 0.4],
    attachTo: 'ceiling',
    interactive: {
      controls: [{ kind: 'toggle' }, { kind: 'slider', label: 'Intensity', min: 0, max: 100, unit: '%', displayMode: 'dial', default: 100 }],
      effects: [{ kind: 'light', intensityRange: [0, 2], color: '#ffffff', offset: [0, -0.15, 0] }],
    },
  },
...

  {
    ...
    offset: [0, 0, 0],
    rotation: [0, 0, 0],
    dimensions: [2, 1.5, 0.3],
  },

  {
    id: 'hedge',
    category: 'outdoor',
    tags: ['vegetation', 'fencing'],
    name: 'Hedge',
