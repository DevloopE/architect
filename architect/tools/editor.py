...
def create_roof(
    ...
    """Create a roof. Put it on its OWN level (one above the top floor).
    The LevelSystem handles vertical stacking, so wallHeight=0.
    RoofNode position = world center of footprint.
